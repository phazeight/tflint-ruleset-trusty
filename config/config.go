...
func New() *Config {
	return &Config{
		Resources: []*Resource{
			...
			{Kind: "google_project_iam_binding", Keys: []string{"project", "role"}},
			...
			{Kind: "kubernetes_manifest", Keys: []string{"manifest.metadata.namespace", "manifest.metadata.name"}},
			...
			// trusty-specific: AWS resources
			{Kind: "aws_instance", Keys: []string{"ami", "instance_type"}},
			{Kind: "aws_s3_bucket", Keys: []string{"bucket"}},
			{Kind: "aws_iam_role", Keys: []string{"name"}},
			{Kind: "aws_iam_policy", Keys: []string{"name"}},
			{Kind: "aws_iam_role_policy_attachment", Keys: []string{"role", "policy_arn"}},
			{Kind: "aws_security_group", Keys: []string{"vpc_id", "name"}},
			{Kind: "aws_vpc", Keys: []string{"cidr_block"}},
			{Kind: "aws_subnet", Keys: []string{"vpc_id", "cidr_block", "availability_zone"}},
			{Kind: "aws_route_table", Keys: []string{"vpc_id"}},
			{Kind: "aws_route_table_association", Keys: []string{"subnet_id", "route_table_id"}},
			{Kind: "aws_lb", Keys: []string{"name"}},
			{Kind: "aws_lb_target_group", Keys: []string{"name", "port", "protocol", "vpc_id"}},
			{Kind: "aws_lb_listener", Keys: []string{"load_balancer_arn", "port", "protocol"}},
			{Kind: "aws_ecs_cluster", Keys: []string{"name"}},
			{Kind: "aws_ecs_service", Keys: []string{"cluster", "name"}},
			{Kind: "aws_ecs_task_definition", Keys: []string{"family"}},
			{Kind: "aws_lambda_function", Keys: []string{"function_name"}},
			{Kind: "aws_cloudwatch_log_group", Keys: []string{"name"}},
			{Kind: "aws_dynamodb_table", Keys: []string{"name"}},
			{Kind: "aws_rds_cluster", Keys: []string{"cluster_identifier"}},
			{Kind: "aws_db_instance", Keys: []string{"identifier"}},
		},
	}
}
